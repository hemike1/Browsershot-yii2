...
use hemike1\Browsershot\Enums\Polling;
use hemike1\Browsershot\Exceptions\CouldNotTakeBrowsershot;
use hemike1\Browsershot\Exceptions\ElementNotFound;
use hemike1\Browsershot\Exceptions\FileDoesNotExistException;
use hemike1\Browsershot\Exceptions\FileUrlNotAllowed;
use hemike1\Browsershot\Exceptions\HtmlIsNotAllowedToContainFile;
use hemike1\Browsershot\Exceptions\UnsuccessfulResponse;
use Spatie\TemporaryDirectory\TemporaryDirectory;
use Symfony\Component\Process\Exception\ProcessFailedException;
use Symfony\Component\Process\Process;

/** @mixin \Spatie\Image\Image */
class BaseBrowsershot
{
